...
def process_inputs(audio_filepath, image_filepath):
    if audio_filepath is not None:  # Check if audio_filepath is valid
        ...
        speech_to_text_output = "No audio input provided."  # Handle the case where no audio is provided
